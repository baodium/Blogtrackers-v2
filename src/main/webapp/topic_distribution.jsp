...
<%
	...
	TopicModelling model = new TopicModelling(blogpostsArray);
...
class ChordDiagram {
    ...
    selectTopic(topic) {
    	...
    	this.draw(this.container, this.height, topicMatrix, this.names, this.colors);
    }
    
    draw(element, height, matrix, NameProvider, colors) {
